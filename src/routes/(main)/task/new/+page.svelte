...
<div class="w-full p-5 pb-0">
    ...
    <p class="m-0 p-0 text-gray-400">внесение в базу данных, импорт .XML-файлов</p>
</div>
<div class="p-5 w-full flex flex-col lg:flex-row gap-x-3 gap-y-3">
    <div class="w-full lg:w-1/2 flex flex-col gap-y-3 h-min">
        <Card class="flex grow h-min min-w-full">
            <form>
                <Button class="w-full">Заполнить из .XML-файла <Icon src={DocumentArrowUp} class="w-4 ml-1 p-0" /></Button>
                <div
                ...
                >
                    <div class="flex flex-col gap-y-3">
                        <Input
                            ...
                            type="text"
                        />
                        <Select placeholder="Округ" items={countries} bind:value={selected} />
                        <Input
                            style="outlined"
                            id="patronymic"
                            name="floating_outlined"
                    ...
                    <div class="flex flex-col gap-y-3">
                        <Select placeholder="Тип объекта" items={countries} bind:value={selected} />
                        <FloatingLabelInput
                            style="outlined"
                            id="email"
                            name="email"
